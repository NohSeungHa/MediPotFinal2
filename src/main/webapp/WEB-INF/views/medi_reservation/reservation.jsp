...
<div style="height:1000px;">
	<div class="col-sm-4">
		...
		<div class="docInfo-div" style="height:auto;margin-bottom:10px;" id="${list.doctorNum }">
			<table id="docInfo">
				<tr>
				...
				<tr>
					<th>학력/경력</th>
					<td><c:forEach var="s" items="${fn:split(list.doctorCareer,',') }">
					${s }<br>
					</c:forEach>
					</td>
				</tr>
