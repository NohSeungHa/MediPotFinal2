		...
		<table id="reserLi" class="table table-hover" style="text-align: center;border-top:2px solid lightgray;">
			<thead>
				<tr>
					...
					<th style="text-align: center;width: 500px;"><h4>남긴메세지</h4></th>
					<th style="text-align: center;width: 90px;"><h4>예약날짜</h4></th>
			...
			<tbody>
				...
				<c:if test="${empty list}">
					<tr>
						<td colspan="10" style="text-align: center;"><h4>예약이 존재하지 않습니다.</h4></td>
					</tr>
				</c:if>
			</tbody>
		</table>
