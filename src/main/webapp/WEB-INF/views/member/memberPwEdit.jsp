...
<jsp:include page="/WEB-INF/views/common/header.jsp">
	<jsp:param value="일반회원 비밀번호 변경" name="pageTitle"/>
</jsp:include>
...
<div class="jointab">
		...
		<p>를 혼용하여 8~16자를 입력해주세요.</p>
			<form action="${pageContext.request.contextPath }/member/memberPwUpdate.do" method="post" onsubmit="return fn_enroll_validate();" >
				<table>
					<tr>
						<th>현재 비밀번호 입력</th>
						<td>
