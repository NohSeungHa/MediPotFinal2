...
public class PageCreate2 {
	
	public String getPageBar(int cPage, int numPerPage, int totalCount, String url,String loc,String sub)
	{
		String pageBar="";
		int pageSize=5;
		...
		else 
		{
			...
			pageBar+="<a href='javascript:fn_paging("+(pageNo-1)+",'"+loc+"','"+sub+"')'>이전</a>";
			pageBar+="</li>";
		}
		while(!(pageNo>pageEnd||pageNo>totalPage))
		{
			...
			{
				pageBar += "<li>";
				pageBar += "<a href=javascript:fn_paging("+pageNo+",'"+loc+"','"+sub+"')>"+pageNo+"</a>";
				pageBar += "</li>";
			}
			pageNo++;
		}
		...
		if(pageNo > totalPage){
			...
			pageBar += "<a href='javascript:fn_paging("+pageNo+",'"+loc+"','"+sub+"')'>다음</a> ";
			pageBar += "</li>";
		}
	...
	public String getPageBar(int cPage, int numPerPage, int totalCount, String url, String hName)
	{
		String pageBar="";
		int pageSize=5;
		...
		pageBar+="<script>";
		pageBar+="function fn_paging(cPage, numPerPage){";
		pageBar+="location.href='"+url+"?cPage='+cPage+'&hName="+hName+"';";
		pageBar+="}";
		pageBar+="</script>";
